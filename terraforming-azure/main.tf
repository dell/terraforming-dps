...
module "ddve" {
  ...
  wan_ip                            = var.wan_ip
  ddve_resource_group_name          = var.create_common_rg ? module.common_rg[0].resource_group_name : var.create_networks ? module.networks[0].resource_group_name : var.resource_group_name
